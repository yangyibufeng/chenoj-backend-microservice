package com.yybf.chenojbackendquestionservice.controller;

import cn.hutool.json.JSONUtil;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.yybf.chenojbackendcommon.annotation.AuthCheck;
import com.yybf.chenojbackendcommon.common.BaseResponse;
import com.yybf.chenojbackendcommon.common.DeleteRequest;
import com.yybf.chenojbackendcommon.common.ErrorCode;
import com.yybf.chenojbackendcommon.common.ResultUtils;
import com.yybf.chenojbackendcommon.constant.UserConstant;
import com.yybf.chenojbackendcommon.exception.BusinessException;
import com.yybf.chenojbackendcommon.exception.ThrowUtils;
import com.yybf.chenojbackendmodel.dto.question.*;
...
public class QuestionController {
    ...
    public BaseResponse<Long> addQuestion(@RequestBody QuestionAddRequest questionAddRequest, HttpServletRequest request) {
        ...
        question.setJudgeConfig(question.getJudgeConfig());
        question.setJudgeCase(question.getJudgeCase());
    ...
    /**
     * 根据 id 获取 ,给要修改自己创建题目的用户一个可以访问自己题目全部信息的接口，没有题目信息脱敏
     *
     * @param id
     * @return
     */
